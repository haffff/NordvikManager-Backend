...
{
    internal class StopSoundCommandHandler : HandlerBase<StopSoundCommand, CommandResponse>
    {
        private readonly IPermissionService permissionService;

        public StopSoundCommandHandler(IDbContext dbContext, IMapper mapper, IPermissionService permissionService)
            : base(dbContext, mapper)
        {
            this.permissionService = permissionService;
        }

        public override async Task<CommandResponse> Handle(StopSoundCommand request, CancellationToken cancellationToken)
        {
